...
> **Build status:** Phase 0 (Foundation), Phase 1 (Onboarding and Personal OS), Phase 2 (Today screen and daily logging), and Phase 3 (Outcome-to-Operating-Parameters engine, meal planning, grocery list, Sunday prep) are complete, deployed, and verified against the live Supabase project. Phase 4 (weekly review and regeneration) is next. See [`README.md`](./README.md) for setup, current status detail, and known gaps — this file remains the product spec and stays unchanged as phases ship.
